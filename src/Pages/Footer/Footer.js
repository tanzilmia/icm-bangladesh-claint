          ...
          <div className="lg:w-1/3">
            ...
            >
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-violet-400">
                <img className="flex-shrink-0 w-5 h-5 rounded-full text-gray-900" src= {logo} alt="" />
              </div>
              <span className="self-center text-2xl font-semibold">
                ICM Bangladesh 
              </span>
            </a>
            <span className="ml-10"> A trustable recelling platform </span>
          </div>
